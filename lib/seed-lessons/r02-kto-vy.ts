...
export const R02_ROUNDS: { title: string; words: VocabSeed[] }[] = [
  {
    title: "1-bosqich",
    words: [
      w("👩‍⚕️", "Врач", "vrach", "ot", "Shifokor", "Человек, который лечит людей.", "Анна — врач.", "Anna — shifokor."),
      w("⚖️", "Юрист", "yuríst", "ot", "Yurist", "Человек, который знает законы и помогает людям.", "Он юрист.", "U yurist."),
      w("🧑‍🔧", "Инженер", "inzhinyér", "ot", "Muhandis", "Человек, который создаёт машины, дома и технику.", "Игорь — инженер.", "Igor — muhandis."),
      w("👨‍💻", "Программист", "pragramíst", "ot", "Dasturchi", "Человек, который пишет программы для компьютера.", "Я программист.", "Men dasturchiman."),
      w("📰", "Журналист", "zhurnalíst", "ot", "Jurnalist", "Человек, который пишет статьи в газету или журнал.", "Олег — журналист.", "Oleg — jurnalist."),
      w("🎹", "Музыкант", "muzikánt", "ot", "Musiqachi", "Человек, который играет музыку.", "Он музыкант.", "U musiqachi."),
      w("🎨", "Художник", "khudózhnik", "ot", "Rassom", "Человек, который рисует картины.", "Это художник.", "Bu rassom."),
      w("✍️", "Писатель", "pisátil'", "ot", "Yozuvchi", "Человек, который пишет книги.", "Толстой — писатель.", "Tolstoy — yozuvchi."),
      w("🤵", "Официант", "afitsiánt", "ot", "Ofitsiant", "Человек, который работает в кафе или ресторане и приносит еду.", "Иван — официант.", "Ivan — ofitsiant."),
      w("🧹", "Домохозяйка", "damakhazyáyka", "ot", "Uy bekasi", "Женщина, которая не работает, а ведёт дом.", "Мама — домохозяйка.", "Onam — uy bekasi."),
    ],
  },
  {
    title: "2-bosqich",
    words: [
      w("🎭", "Актёр", "aktyór", "ot", "Aktyor", "Мужчина, который играет в кино или в театре.", "Это актёр.", "Bu aktyor."),
      w("🎬", "Актриса", "aktrísa", "ot", "Aktrisa", "Женщина, которая играет в кино или в театре.", "Она актриса.", "U aktrisa."),
      w("🎤", "Певец", "pivyéts", "ot", "Qo'shiqchi (erkak)", "Мужчина, который поёт.", "Он певец.", "U qo'shiqchi."),
      w("👩‍🎤", "Певица", "pivítsa", "ot", "Qo'shiqchi (ayol)", "Женщина, которая поёт.", "Она певица.", "U qo'shiqchi."),
      w("⚽", "Спортсмен", "spartsmén", "ot", "Sportchi (erkak)", "Мужчина, который занимается спортом.", "Он спортсмен.", "U sportchi."),
      w("🏃‍♀️", "Спортсменка", "spartsménka", "ot", "Sportchi (ayol)", "Женщина, которая занимается спортом.", "Мария — спортсменка.", "Mariya — sportchi."),
      w("🧔", "Мужчина", "muzhchína", "ot", "Erkak", "Взрослый человек мужского пола. Слово мужского рода: этот мужчина.", "Этот мужчина — врач.", "Bu erkak — shifokor."),
      w("👩‍🦱", "Женщина", "zhénshchina", "ot", "Ayol", "Взрослый человек женского пола.", "Эта женщина — певица.", "Bu ayol — qo'shiqchi."),
      w("👦", "Мальчик", "mál'chik", "ot", "O'g'il bola", "Ребёнок мужского пола.", "Это мальчик.", "Bu o'g'il bola."),
      w("👧", "Девочка", "dyévachka", "ot", "Qiz bola", "Ребёнок женского пола.", "Это девочка.", "Bu qiz bola."),
    ],
  },
  {
    title: "3-bosqich",
    words: [
      w("🇷🇺", "Россия", "rassíya", "ot", "Rossiya", "Самая большая страна в мире.", "Москва — это Россия.", "Moskva — bu Rossiya."),
      w("🇬🇧", "Англия", "ángliya", "ot", "Angliya", "Страна, где говорят по-английски.", "Лондон — это Англия.", "London — bu Angliya."),
      w("🇺🇸", "Америка", "amyérika", "ot", "Amerika", "США — Соединённые Штаты Америки.", "Нью-Йорк — это Америка.", "Nyu-York — bu Amerika."),
      w("🇩🇪", "Германия", "girmániya", "ot", "Germaniya", "Страна в Европе; там говорят по-немецки.", "Берлин — это Германия.", "Berlin — bu Germaniya."),
      w("🇫🇷", "Франция", "frántsiya", "ot", "Fransiya", "Страна в Европе; там говорят по-французски.", "Париж — это Франция.", "Parij — bu Fransiya."),
      w("🇮🇹", "Италия", "itáliya", "ot", "Italiya", "Страна в Европе; там говорят по-итальянски.", "Рим — это Италия.", "Rim — bu Italiya."),
      w("🇪🇸", "Испания", "ispániya", "ot", "Ispaniya", "Страна в Европе; там говорят по-испански.", "Мадрид — это Испания.", "Madrid — bu Ispaniya."),
      w("🇯🇵", "Япония", "ipóniya", "ot", "Yaponiya", "Страна в Азии; там говорят по-японски.", "Токио — это Япония.", "Tokio — bu Yaponiya."),
      w("🇨🇳", "Китай", "kitáy", "ot", "Xitoy", "Большая страна в Азии.", "Пекин — это Китай.", "Pekin — bu Xitoy."),
      w("🇧🇷", "Бразилия", "brazíliya", "ot", "Braziliya", "Большая страна в Южной Америке.", "Рио — это Бразилия.", "Rio — bu Braziliya."),
    ],
  },
  {
    title: "4-bosqich",
    words: [
      w("🗣️", "По-русски", "pa-rússki", "ravish", "Ruscha (gapirmoq)", "На русском языке.", "Я говорю по-русски.", "Men ruscha gapiraman."),
      w("💬", "По-английски", "pa-anglíyski", "ravish", "Inglizcha", "На английском языке.", "Вы говорите по-английски?", "Siz inglizcha gapirasizmi?"),
      w("🥨", "По-немецки", "pa-nyémitski", "ravish", "Nemischa", "На немецком языке.", "Он говорит по-немецки.", "U nemischa gapiradi."),
      w("🥐", "По-французски", "pa-frantsúski", "ravish", "Fransuzcha", "На французском языке.", "Она говорит по-французски.", "U fransuzcha gapiradi."),
      w("👄", "Говорить", "gavarít'", "fe'l", "Gapirmoq", "Произносить слова, разговаривать. Я говорю, ты говоришь, они говорят.", "Говорить по-русски — это интересно.", "Ruscha gapirish — bu qiziqarli."),
      w("🧠", "Знать", "znat'", "fe'l", "Bilmoq", "Иметь информацию. Я знаю, ты знаешь, они знают.", "Знать русский язык — хорошо.", "Rus tilini bilish — yaxshi."),
      w("🤔", "Думать", "dúmat'", "fe'l", "O'ylamoq", "Иметь мнение. Я думаю, ты думаешь, они думают.", "Думать по-русски — это трудно.", "Ruscha o'ylash — bu qiyin."),
      w("📍", "Откуда", "atkúda", "so'roq", "Qayerdan?", "Вопрос о месте, из которого человек или вещь.", "Откуда Вы?", "Siz qayerdansiz?"),
      w("🧮", "Сколько", "skól'ka", "so'roq", "Qancha? Necha?", "Вопрос о количестве.", "Сколько Вам лет?", "Siz necha yoshdasiz?"),
      w("🤏", "Чуть-чуть", "chut'-chút'", "ravish", "Ozgina", "Очень мало, немного.", "Я говорю по-русски чуть-чуть.", "Men ozgina ruscha gapiraman."),
    ],
  },
];
